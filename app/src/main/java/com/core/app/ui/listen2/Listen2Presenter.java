...
public class Listen2Presenter<V extends IListen2View> extends BasePresenter<V> implements IListen2Presenter<V> {
    ...
    @Inject
    public Listen2Presenter(DataManager dataManager, CompositeDisposable compositeDisposable) {
    ...
    public void checkAnswer(int i) {
        ...
        if (mCurrentTestIndex >= wordByTopics.size()) {
            ...
            mResultTest.setListen2(mCountCorrect*100/wordByTopics.size());
    ...
    private void showQA() {
        ...
        getMvpView().showQA(this.mAnswer1, this.mAnsewer2);
        Handler handler = new Handler();
        handler.postDelayed(this::play,800);
    }
